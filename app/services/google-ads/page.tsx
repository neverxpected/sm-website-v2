      ...
      <section className="relative pt-40 pb-24 px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-[46px] font-black tracking-tight leading-[1.1] mb-8 text-white">
            ...
            `}</style>
            <span className="google-shimmer-text lg:text-[46px]">Are You the First Thing They See?</span>
          </h1>
          ...
          <div className="relative inline-flex items-center justify-center">
            <span className="absolute -inset-[4px] rounded-[16px]" style={{
              ...
              animation: 'googleAdsShimmer 3s linear infinite',
            }} />
            <Link
              href="/strategy-call"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            {services.map((s) => (
              <div key={s.title} className="p-8 rounded-2xl flex flex-col gap-5"
                style={{ background: 'rgba(47,232,162,0.04)', border: '1px solid rgba(47,232,162,0.2)' }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            {technical.map((t) => (
              <div key={t.title} className="p-8 rounded-2xl flex flex-col gap-5"
                style={{ background: 'rgba(47,232,162,0.03)', border: '1px solid rgba(47,232,162,0.15)', backdropFilter: 'blur(16px)' }}>
                <span className="w-12 h-12 rounded-xl flex items-center justify-center shrink-0"
                  style={{ background: '#2fe8a2', color: '#000000' }}>
                  {t.icon}
                </span>
          ...
          <div className="flex flex-col gap-0">
            {process.map((p, i) => (
              <div key={p.step} className="flex gap-8 pb-12 relative">
                {i < process.length - 1 && (
                  <div className="absolute left-6 top-14 bottom-0 w-px" style={{ background: 'rgba(47,232,162,0.25)' }} />
                )}
