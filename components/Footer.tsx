    ...
    <footer style={{ background: '#000000' }}>
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-8 pt-8 pb-16">
          ...
          <div className="space-y-2 text-center md:min-w-[220px] md:shrink-0 md:border-r md:pr-10" style={{ borderColor: 'rgba(47,232,162,0.3)' }}>
            <Link href="/" className="flex items-center justify-center group">
              <Image
                ...
                width={480}
                height={120}
                className="h-[4.8rem] w-auto object-contain transition-all duration-300 group-hover:scale-105"
              />
            </Link>
            ...
            <p className="text-sm leading-relaxed text-center mx-auto" style={{ color: 'rgba(240,244,255,0.35)', maxWidth: '220px' }}>
              &ldquo;Psalm 127:1 ~ Unless the LORD builds a house, its builders<br />labor over it in vain&rdquo;
            </p>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-center sm:justify-end gap-4 sm:gap-6"
          style={{ borderTop: '1px solid rgba(47,232,162,0.3)' }}>
