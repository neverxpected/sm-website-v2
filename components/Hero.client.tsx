    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 sm:pt-32 lg:pt-40 pb-8 sm:pb-16">
        <div className="max-w-7xl mx-auto text-center">
          {/* Eyebrow */}
          <div
            className="reveal reveal-delay-100 inline-flex items-center gap-2 mb-8 px-3 py-2 rounded-full text-[8px] sm:text-[10px] md:text-xs font-bold uppercase tracking-[0.15em] sm:tracking-[0.2em] text-center leading-tight"
            style={{
          ...
          {stats.length > 0 && (
            <div className="reveal reveal-delay-400 hidden sm:flex flex-nowrap items-center justify-center gap-3 sm:gap-8 mb-3">
              {stats.map((stat) => (
                ...
                >
                  <p
                    className="text-lg sm:text-3xl font-black mb-1 whitespace-nowrap"
                    style={{
                  ...
                  <p
                    className="text-[7px] sm:text-xs font-semibold uppercase tracking-[0.08em] sm:tracking-widest"
          ...
          {trustBadges.length > 0 && (
            <div className="reveal reveal-delay-500 hidden sm:flex flex-nowrap items-center justify-center gap-3 sm:gap-6 mb-6">
              {trustBadges.map((badge) => (
                <span
                  key={badge}
                  className="flex items-center gap-1.5 text-[10px] sm:text-sm font-medium whitespace-nowrap"
          ...
          <div className="reveal reveal-delay-600 flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
            <Link
              ...
              style={{
                ...
                animation: 'ctaGlowPink 3s ease-in-out infinite',
              }}
            >
              {ctaText}
              <svg
