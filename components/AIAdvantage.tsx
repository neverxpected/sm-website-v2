...
export default function AIAdvantage() {
  ...
  const accentColors = [
    { bg: 'rgba(163,230,53,0.12)', border: 'rgba(163,230,53,0.30)', text: lime.accent },
    { bg: 'rgba(163,230,53,0.08)', border: 'rgba(163,230,53,0.20)', text: '#84cc16' },
    { bg: 'rgba(163,230,53,0.06)', border: 'rgba(163,230,53,0.16)', text: '#65a30d' },
  ];

  return (
    <section className="py-24 px-6 lg:px-8 relative overflow-hidden" style={{ background: '#0a0a0a' }}>
      {/* Background orb */}
            ...
            <div className="flex flex-col lg:flex-row gap-8 h-full">
              ...
              <div className="flex-1 flex flex-col gap-5">
                ...
                <ul className="space-y-2.5">
                  {tab.bullets.map((b) => (
                    <li key={b} className="flex items-start gap-2.5">
                      <svg viewBox="0 0 24 24" fill="none" className="w-4 h-4 mt-0.5 shrink-0" stroke={lime.accent} strokeWidth={2.5}>
                ...
                <div className="mt-auto pt-2">
                  <Link
                    href={tab.href}
                    className="inline-flex items-center gap-2 px-6 py-3 text-black text-sm font-bold rounded-xl transition-all duration-300 hover:scale-105"
